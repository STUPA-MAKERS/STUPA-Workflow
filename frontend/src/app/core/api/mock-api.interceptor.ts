...
const MOCK_PRINCIPAL: Principal = {
  ...
  roles: ['member'],
  // Every gated view must be reachable in the dev, harness and demo builds, so the
  // mock principal holds the whole catalogue of
  // `backend/app/shared/permissions.py`. Keep both in step.
  permissions: [
    'application.read',
