...
export const de = {
  ...
  'admin.accounts.fintsEndpointPlaceholder': 'z. B. https://banking-sparkasse.de/fints',
...
export const en: Partial<Record<TranslationKey, string>> = {
  ...
  'admin.accounts.fintsEndpointPlaceholder': 'e.g. https://banking-sparkasse.de/fints',
