...
export const de = {
  ...
  'budget.tree.fyLabel': 'Bezeichnung',
  'budget.tree.fyLabelPlaceholder': 'z. B. 2026',
  'budget.tree.fyStart': 'Start',
  'budget.tree.fyEnd': 'Ende',
  ...
  'budget.tree.toast.fyFailed': 'Haushaltsjahr konnte nicht angelegt werden (überschneidet sich?).',
...
export const en: Partial<Record<TranslationKey, string>> = {
  ...
  'budget.tree.fyLabel': 'Label',
  'budget.tree.fyLabelPlaceholder': 'e.g. 2026',
  'budget.tree.fyStart': 'Start',
  'budget.tree.fyEnd': 'End',
  ...
  'budget.tree.toast.fyFailed': 'Fiscal year could not be created (overlapping?).',
