...
export const de = {
  ...
  'nav.budget': 'Budget',
  'nav.expenses': 'Ausgaben/Einnahmen',
  ...
  'expenses.title': 'Ausgaben/Einnahmen',
  ...
  'expenses.field.inheritedCostCentre': 'Kostenstelle und Haushaltsjahr werden vom Antrag übernommen.',
  ...
  'admin.gremien.quorumHint': 'Standard-Quorum für Abstimmungen dieses Gremiums: Anteil der Stimmberechtigten (0–100 %), der teilnehmen muss. Leer = kein Quorum.',
...
export const en: Partial<Record<TranslationKey, string>> = {
  ...
  'expenses.field.inheritedCostCentre': 'Cost centre and fiscal year are taken from the application.',
  ...
  'admin.gremien.quorum': 'Quorum (%)',
  'admin.gremien.quorumHint': 'Default quorum for votes in this committee: share of eligible voters (0–100%) who must participate. Empty = no quorum.',
