...
export const de = {
  ...
  'admin.flow.group.collapse': 'Zuklappen',
  'admin.flow.group.expand': 'Aufklappen',
  'admin.flow.group.dissolve': 'Gruppe auflösen',
  'admin.flow.group.dissolveHint':
    'Auflösen entfernt nur die visuelle Klammer — Schritte und Übergänge bleiben unverändert.',
  'admin.flow.group.multiHint':
    'Shift-Klick wählt mehrere Schritte aus; „Gruppieren“ in der Werkzeugleiste fasst sie zusammen.',
...
export const en: Partial<Record<TranslationKey, string>> = {
  ...
  'admin.flow.group.collapse': 'Collapse',
  'admin.flow.group.expand': 'Expand',
  'admin.flow.group.dissolve': 'Dissolve group',
  'admin.flow.group.dissolveHint':
    'Dissolving only removes the visual bracket — steps and transitions stay unchanged.',
  'admin.flow.group.multiHint':
    'Shift-click selects multiple steps; “Group” in the toolbar bundles them.',
