...
export const de = {
  ...
  'applications.approval.title': 'Entscheidung',
  'applications.approval.lead': 'Diesen Antrag im Namen Ihres Gremiums annehmen oder ablehnen.',
  'applications.approval.accept': 'Annehmen',
  'applications.approval.reject': 'Ablehnen',
  'applications.approval.forbidden': 'Sie haben in diesem Gremium nicht die nötige Rolle.',
...
export const en: Partial<Record<TranslationKey, string>> = {
  ...
  'applications.approval.title': 'Decision',
  'applications.approval.lead': 'Accept or reject this application on behalf of your committee.',
  'applications.approval.accept': 'Accept',
  'applications.approval.reject': 'Reject',
  'applications.approval.forbidden': 'You do not hold the required role in this committee.',
