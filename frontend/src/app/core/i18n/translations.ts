...
export const de = {
  ...
  'account.scope.budget_write.desc': 'Kostenstellen, Buchungen und Konten verwalten.',
  ...
  'expenses.field.account': 'Konto (optional)',
  'expenses.field.accountPlaceholder': 'Kein Konto',
  ...
  'expenses.filter.account': 'Konto',
  'expenses.filter.allAccounts': 'Alle Konten',
  ...
  'expenses.sub.inherits': 'Erbt Kostenstelle, Konto, HHJ und Art von „{parent}".',
  'expenses.sub.empty': 'Noch keine Unterbuchungen — aus Datei hinzufügen.',
  'expenses.sub.imported': '{count} Unterbuchung(en) importiert.',
  ...
  'admin.accounts.iban': 'IBAN',
  'admin.accounts.ibanPlaceholder': 'z. B. DE89 3704 0044 0532 0130 00',
  'admin.accounts.status': 'Status',
  'admin.accounts.active': 'Aktiv',
  'admin.accounts.inactive': 'Inaktiv',
  'admin.accounts.toastSaved': 'Konto gespeichert.',
  'admin.accounts.toastDeleted': 'Konto gelöscht.',
  'admin.accounts.toastFailed': 'Aktion fehlgeschlagen.',
  'admin.accounts.fintsTitle': 'FinTS-Bank-Verbindung (optional)',
  'admin.accounts.fintsDesc':
    'Bank-Verbindung zum Abruf echter Kontoumsätze. Den persönlichen Anmeldenamen und die PIN ' +
    'hinterlegt jeder Bucher selbst beim ersten Verbinden im Buchungs-Tab.',
  'admin.accounts.fintsEndpoint': 'FinTS-Endpunkt (URL)',
  'admin.accounts.fintsEndpointPlaceholder': 'z. B. https://banking-bw3.s-fints-pt-bw.de/fints30',
  'admin.accounts.fintsBlz': 'Bankleitzahl (BLZ)',
  'fints.button': 'Bankumsätze',
  'fints.title': 'Bankumsätze abgleichen',
  'fints.tabFints': 'FinTS-Abruf',
  ...
  'fints.connect': 'Verbinden',
  'fints.connectedAs': 'Verbunden als {login}',
  'fints.changeLogin': 'Zugangsdaten ändern',
  'fints.disconnect': 'Trennen',
  'fints.credSaved': 'Zugangsdaten gespeichert.',
  'fints.credRemoved': 'Zugangsdaten entfernt.',
  ...
  'fints.tanConfirm': 'TAN bestätigen',
  'fints.tanDigit': 'TAN-Ziffer {n}',
  'fints.tanOtherLength': 'TAN hat eine andere Länge?',
  'fints.tanDecoupled': 'Bitte in deiner Banking-App freigeben, dann prüfen.',
  'fints.tanPoll': 'Freigabe prüfen',
  'fints.tanPending': 'Noch nicht freigegeben — bitte in der App bestätigen.',
  ...
  'fints.emptyFiltered': 'Keine Umsätze passen zum Filter.',
  'fints.filter.search': 'Suche',
  'fints.filter.searchPlaceholder': 'Gegenkonto oder Verwendungszweck …',
  'fints.col.date': 'Datum',
  'fints.col.kind': 'Art',
  'fints.col.counterparty': 'Gegenkonto',
  'fints.col.purpose': 'Verwendungszweck',
  'fints.col.amount': 'Betrag',
  'fints.costCentre': 'Kostenstelle',
  'fints.costCentrePlaceholder': 'Kostenstelle wählen …',
  'fints.book': 'Buchen',
  'fints.ignore': 'Ignorieren',
  'fints.booked': 'Umsatz gebucht.',
  'fints.imported': '{imported} neu, {duplicates} bereits vorhanden.',
  'fints.errSync': 'FinTS-Abruf fehlgeschlagen.',
  'fints.errNotConfigured': 'Für dieses Konto ist keine FinTS-Bank-Verbindung hinterlegt.',
  'fints.errNoCredential':
  ...
  'konten.accounts': 'Konten',
  'konten.noAccounts': 'Keine Konten vorhanden.',
  'konten.pickAccount': 'Konto links wählen.',
  'konten.balance': 'Kontostand',
  'konten.balanceAsOf': 'Stand {date}',
  'konten.connection': 'Verbindung',
  'konten.lastSync': 'Letzter Abruf: {date}',
  'konten.notConfigured': 'Für dieses Konto ist keine FinTS-Bank-Verbindung hinterlegt (Verwaltung → Konten).',
  'konten.importFile': 'Datei-Import (CAMT/MT940)',
  'konten.transactions': 'Transaktionen',
  'konten.empty': 'Noch keine Transaktionen — synchronisieren.',
  'konten.filter.status': 'Status',
  'konten.filter.open': 'Offen',
  'konten.filter.linked': 'Verknüpft',
  'konten.filter.ignored': 'Ignoriert',
  'konten.badge.ignored': 'Ignoriert',
  'konten.col.booking': 'Buchung',
  'konten.linked': 'verknüpft',
  'konten.open': 'offen',
  'konten.action.link': 'Verknüpfen',
  'konten.action.import': 'Importieren',
  'konten.action.unlink': 'Trennen',
  'konten.action.ignore': 'Ignorieren',
  'konten.action.reactivate': 'Reaktivieren',
  'konten.ignoreTitle': 'Transaktion ignorieren',
  'konten.ignoreHint': 'Die Zeile wird aus dem Abgleich ausgeblendet, aber aufbewahrt (auditiert). Über den Filter „Ignoriert" reaktivierbar.',
  'konten.ignoreReason': 'Grund (optional)',
  ...
  'konten.bulk.unlinkTitle': 'Zuordnungen trennen',
  'konten.bulk.unlinkBody': 'Zuordnung von {count} ausgewählten Umsätzen wirklich lösen?',
  'konten.bulk.unlinkConfirm': 'Trennen',
  'konten.bulk.unlinkDone': '{count} Zuordnung(en) gelöst.',
  'konten.bulk.ignoreSelected': 'Ignorieren',
  'konten.bulk.ignoreTitle': 'Umsätze ignorieren',
  'konten.bulk.ignoreBody': '{count} ausgewählte Umsätze als irrelevant markieren?',
  'konten.bulk.ignoreConfirm': 'Ignorieren',
  'konten.bulk.ignoreDone': '{count} Umsatz/Umsätze ignoriert.',
  'konten.bulk.error': 'Sammel-Aktion fehlgeschlagen.',
  'konten.importTitle': 'Als neue Buchung importieren',
  'konten.linkTitle': 'Mit bestehender Buchung verknüpfen',
  'konten.linkBooking': 'Buchung',
  'konten.linkBookingPlaceholder': 'Buchung suchen/wählen …',
  'konten.linkPicked': 'Gewählt',
  'konten.noLinkCandidates': 'Keine passende, noch nicht verknüpfte Buchung gefunden.',
...
export const en: Partial<Record<TranslationKey, string>> = {
  ...
  'account.scope.budget_write.desc': 'Manage cost centres, bookings, and accounts.',
  ...
  'expenses.field.account': 'Account (optional)',
  'expenses.field.accountPlaceholder': 'No account',
  ...
  'expenses.filter.account': 'Account',
  'expenses.filter.allAccounts': 'All accounts',
  ...
  'expenses.sub.inherits': 'Inherits cost-centre, account, fiscal year and kind from “{parent}”.',
  'expenses.sub.empty': 'No sub-bookings yet — add from a file.',
  'expenses.sub.imported': '{count} sub-booking(s) imported.',
  ...
  'admin.accounts.desc': 'Maintain bank accounts (name + IBAN) — free, not tied to cost centres.',
  ...
  'admin.accounts.name': 'Name',
  'admin.accounts.iban': 'IBAN',
  'admin.accounts.ibanPlaceholder': 'e.g. DE89 3704 0044 0532 0130 00',
  'admin.accounts.status': 'Status',
  'admin.accounts.active': 'Active',
  'admin.accounts.inactive': 'Inactive',
  'admin.accounts.toastSaved': 'Account saved.',
  'admin.accounts.toastDeleted': 'Account deleted.',
  'admin.accounts.toastFailed': 'Action failed.',
  'admin.accounts.fintsTitle': 'FinTS bank connection (optional)',
  'admin.accounts.fintsDesc':
    'Bank connection for fetching real account transactions. Each user stores their own login ' +
    'and PIN when connecting for the first time in the bookings tab.',
  'admin.accounts.fintsEndpoint': 'FinTS endpoint (URL)',
  'admin.accounts.fintsEndpointPlaceholder': 'e.g. https://banking-bw3.s-fints-pt-bw.de/fints30',
  'admin.accounts.fintsBlz': 'Bank code (BLZ)',
  'fints.button': 'Bank transactions',
  'fints.title': 'Reconcile bank transactions',
  'fints.tabFints': 'FinTS sync',
  ...
  'fints.connect': 'Connect',
  'fints.connectedAs': 'Connected as {login}',
  'fints.changeLogin': 'Change credentials',
  'fints.disconnect': 'Disconnect',
  'fints.credSaved': 'Credentials saved.',
  'fints.credRemoved': 'Credentials removed.',
  'fints.tanPrompt': 'Enter a TAN or approve in your banking app.',
  'fints.tan': 'TAN',
  'fints.tanImageAlt': 'TAN image (photoTAN/QR-TAN) to scan',
  'fints.tanConfirm': 'Confirm TAN',
  'fints.tanDigit': 'TAN digit {n}',
  'fints.tanOtherLength': 'TAN has a different length?',
  'fints.tanDecoupled': 'Please approve in your banking app, then check.',
  'fints.tanPoll': 'Check approval',
  'fints.tanPending': 'Not approved yet — please confirm in the app.',
  'fints.file': 'CAMT.053 or MT940 file',
  'fints.fileChoose': 'Choose file',
  'fints.drop': 'Drop file here',
  'fints.fileHint': 'Export an account statement from online banking (CAMT.053 or MT940 format).',
  'fints.openLines': 'Open transactions',
  'fints.loading': 'Loading …',
  'fints.empty': 'No open transactions to reconcile.',
  'fints.emptyFiltered': 'No transactions match the filter.',
  'fints.filter.search': 'Search',
  'fints.filter.searchPlaceholder': 'Counterparty or reference …',
  'fints.col.date': 'Date',
  'fints.col.kind': 'Type',
  'fints.col.counterparty': 'Counterparty',
  'fints.col.purpose': 'Reference',
  'fints.col.amount': 'Amount',
  'fints.costCentre': 'Cost centre',
  'fints.costCentrePlaceholder': 'Choose cost centre …',
  'fints.book': 'Book',
  'fints.ignore': 'Ignore',
  'fints.booked': 'Transaction booked.',
  'fints.imported': '{imported} new, {duplicates} already present.',
  'fints.errSync': 'FinTS sync failed.',
  'fints.errNotConfigured': 'This account has no FinTS bank connection configured.',
  'fints.errNoCredential':
  ...
  'konten.noAccounts': 'No accounts yet.',
  'konten.pickAccount': 'Pick an account on the left.',
  'konten.balance': 'Balance',
  'konten.balanceAsOf': 'as of {date}',
  'konten.connection': 'Connection',
  'konten.lastSync': 'Last sync: {date}',
  'konten.notConfigured': 'No FinTS bank connection set for this account (Admin → Accounts).',
  'konten.importFile': 'File import (CAMT/MT940)',
  'konten.transactions': 'Transactions',
  'konten.empty': 'No transactions yet — sync.',
  'konten.filter.status': 'Status',
  'konten.filter.open': 'Open',
  'konten.filter.linked': 'Linked',
  'konten.filter.ignored': 'Ignored',
  'konten.badge.ignored': 'Ignored',
  'konten.col.booking': 'Booking',
  'konten.linked': 'linked',
  'konten.open': 'open',
  'konten.action.link': 'Link',
  'konten.action.import': 'Import',
  'konten.action.unlink': 'Unlink',
  'konten.action.ignore': 'Ignore',
  'konten.action.reactivate': 'Reactivate',
  'konten.ignoreTitle': 'Ignore transaction',
  'konten.ignoreHint': 'The line is hidden from reconciliation but kept (audited). Reactivate it via the “Ignored” filter.',
  'konten.ignoreReason': 'Reason (optional)',
  ...
  'konten.bulk.unlinkTitle': 'Unlink matches',
  'konten.bulk.unlinkBody': 'Really unlink {count} selected transactions?',
  'konten.bulk.unlinkConfirm': 'Unlink',
  'konten.bulk.unlinkDone': '{count} match(es) unlinked.',
  'konten.bulk.ignoreSelected': 'Ignore',
  'konten.bulk.ignoreTitle': 'Ignore transactions',
  'konten.bulk.ignoreBody': 'Mark {count} selected transactions as irrelevant?',
  'konten.bulk.ignoreConfirm': 'Ignore',
  'konten.bulk.ignoreDone': '{count} transaction(s) ignored.',
  'konten.bulk.error': 'Bulk action failed.',
  'konten.importTitle': 'Import as a new booking',
  'konten.linkTitle': 'Link to an existing booking',
  'konten.linkBooking': 'Booking',
  'konten.linkBookingPlaceholder': 'Search/select a booking …',
  'konten.linkPicked': 'Selected',
  'konten.noLinkCandidates': 'No matching unlinked booking found.',
