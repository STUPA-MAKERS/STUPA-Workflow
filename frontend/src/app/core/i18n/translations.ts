...
export const de = {
  ...
  'admin.accounts.fintsTitle': 'FinTS-Bankzugang (optional)',
  'admin.accounts.fintsDesc':
    'Online-Banking-Zugang zum Abruf echter Kontoumsätze. Die PIN wird nur verschlüsselt gespeichert.',
  ...
  'admin.accounts.fintsLogin': 'Anmeldename / Benutzerkennung',
  'admin.accounts.fintsPin': 'PIN',
  'admin.accounts.fintsPinPlaceholder': 'Online-Banking-PIN',
  'admin.accounts.fintsPinStored': '•••••• (gespeichert — leer lassen = unverändert)',
  ...
  'fints.errNotConfigured': 'Für dieses Konto ist kein vollständiger FinTS-Zugang hinterlegt.',
...
export const en: Partial<Record<TranslationKey, string>> = {
  ...
  'admin.accounts.fintsTitle': 'FinTS bank access (optional)',
  'admin.accounts.fintsDesc':
    'Online-banking access for fetching real account transactions. The PIN is stored encrypted only.',
  ...
  'admin.accounts.fintsLogin': 'Login / user ID',
  'admin.accounts.fintsPin': 'PIN',
  'admin.accounts.fintsPinPlaceholder': 'Online-banking PIN',
  'admin.accounts.fintsPinStored': '•••••• (stored — leave blank to keep)',
  ...
  'fints.errNotConfigured': 'This account has no complete FinTS access configured.',
