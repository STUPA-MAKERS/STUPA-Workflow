...
export const de = {
  ...
  'meetings.control.needProtokollant':
    'Protokollant zuweisen, um die Sitzung zu starten.',
  ...
  'meetings.vote.quorumHint':
    'Leer lassen, um die Standardwerte des Gremiums zu verwenden.',
  ...
  'admin.forms.deleteFailed':
    'Löschen fehlgeschlagen – ggf. existieren noch Anträge dieser Art.',
  ...
  'admin.forms.cmpRequiredHint':
    'Antragsteller müssen Vergleichsangebote beilegen.',
  ...
  'admin.gremien.membersLoadFailed': 'Mitglieder konnten nicht geladen werden (fehlende Berechtigung?).',
...
export const en: Partial<Record<TranslationKey, string>> = {
  ...
  'admin.forms.deleteFailed':
    'Delete failed — applications of this type may still exist.',
