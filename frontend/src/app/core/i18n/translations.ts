...
export const de = {
  ...
  'budget.subtitle': 'Auslastung der Töpfe und Verteilung der Anträge.',
  ...
  'budget.empty.body':
    'Für die aktuelle Auswahl gibt es keine Töpfe oder Anträge. Anträge ohne Budget bleiben davon unberührt.',

  'budget.filter.heading': 'Filter',
  'budget.filter.pot': 'Topf',
  ...
  'budget.usage.heading': 'Auslastung je Topf',
  'budget.usage.subtitle': 'Gebundene Mittel (ausgezahlt / bewilligt / reserviert) gegen das Topf-Limit.',
  'budget.usage.empty': 'Keine Töpfe für die aktuelle Auswahl.',
  ...
  'budget.usage.table.caption': 'Auslastung je Topf und Stufe (Tabellenansicht)',
  'budget.usage.col.pot': 'Topf',
...
export const en: Partial<Record<TranslationKey, string>> = {
  ...
  'budget.subtitle': 'Pot utilisation and the distribution of applications.',
  ...
  'budget.empty.body':
    'There are no pots or applications for the current selection. Applications without a budget are unaffected.',

  'budget.filter.heading': 'Filters',
  'budget.filter.pot': 'Pot',
  ...
  'budget.usage.heading': 'Utilisation per pot',
  'budget.usage.subtitle': 'Committed funds (paid / approved / reserved) against the pot limit.',
  'budget.usage.empty': 'No pots for the current selection.',
  ...
  'budget.usage.table.caption': 'Utilisation per pot and stage (table view)',
  'budget.usage.col.pot': 'Pot',
  'budget.usage.col.total': 'Limit',
