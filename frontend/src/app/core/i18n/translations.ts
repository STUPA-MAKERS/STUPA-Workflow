...
export const de = {
  ...
  'account.calendar.urlLabel': 'Abo-URL',
  'account.calendar.copy': 'Kopieren',
  'account.calendar.copied': 'Kopiert!',
  'account.calendar.none': 'Es wurde noch kein Abo-Link erzeugt.',
  'account.calendar.generate': 'Abo-Link erzeugen',
  ...
  'account.notifications.hint.comment': 'Wenn ein Antrag kommentiert wird, der dich betrifft.',
  ...
  'account.notifications.hint.meeting': 'Einladung und Tagesordnung von Sitzungen deiner Gremien.',
  ...
  'account.notifications.hint.role_change': 'Wenn dir eine Rolle zugewiesen oder entzogen wird.',
  ...
  'account.grants.active': 'Aktive Zugriffe',
  'account.grants.empty': 'Keine aktiven Zugriffe.',
  'account.grants.error': 'Zugriffe konnten nicht geladen werden.',
  'account.grants.scope': 'Umfang',
  'account.grants.created': 'Erstellt',
  'account.grants.expires': 'Läuft ab',
  'account.grants.revoke': 'Widerrufen',
  'account.grants.revokeAll': 'Alle widerrufen',
  'account.mcp.title': 'MCP-Server',
  'account.mcp.intro':
    'Lade den MCP-Server, mit dem Agenten die Plattform-API nutzen können. Das Paket ist bereits auf diese Plattform vorkonfiguriert.',
  'account.mcp.download': 'MCP-Paket herunterladen',
  'account.mcp.step1': 'Paket entpacken.',
  'account.mcp.step3': 'Folgenden Eintrag in die MCP-Konfiguration deines Clients aufnehmen:',
  'account.mcp.config': 'MCP-Konfiguration',
  'account.mcp.wired': 'Vorkonfigurierte Plattform-URL',
  'account.grants.never': 'Läuft nie ab',
  'account.consent.title': 'Zugriff erlauben',
  'account.consent.intro':
    'Ein Agent (MCP) möchte in deinem Namen handeln. Wähle Umfang und Gültigkeitsdauer.',
  'account.consent.scopes': 'Berechtigungen',
  'account.consent.lifetime': 'Gültigkeitsdauer',
  'account.consent.approve': 'Erlauben',
  'account.consent.deny': 'Ablehnen',
  'account.consent.error': 'Anfrage konnte nicht verarbeitet werden.',
  'account.consent.notAllowed': 'Dir fehlt die Berechtigung »mcp.use« für API-Agenten.',
  'account.consent.notHeld': 'Du besitzt dieses Recht aktuell nicht — der Agent erhält es nicht.',
  'account.lifetime.1h': '1 Stunde',
  'account.lifetime.8h': '8 Stunden',
  'account.lifetime.1d': '1 Tag',
  'account.lifetime.30d': '30 Tage',
  'account.lifetime.90d': '90 Tage',
  'account.lifetime.never': 'Läuft nie ab',
  ...
  'account.scope.forms_write.desc': 'Formularversionen anlegen und aktivieren.',
  'account.scope.flows_write.label': 'Workflows bearbeiten',
  'account.scope.flows_write.desc': 'Flow-Definitionen (Status/Übergänge) ändern.',
  'account.scope.admin_write.label': 'Administration',
  'account.scope.admin_write.desc': 'Gremien, Rollen, Rechte und Webhooks verwalten.',
  ...
  'expenses.transferToast': 'Übertrag gebucht.',
  'expenses.tab.bookings': 'Buchungen',
  'expenses.tab.transfers': 'Überträge',
  'expenses.transfers.from': 'Von',
  'expenses.transfers.to': 'Nach',
  'expenses.transfers.empty': 'Keine Überträge gefunden.',
  'expenses.transfers.editTitle': 'Übertrag bearbeiten',
  'expenses.transfers.pairLocked':
    'Die beiden Kostenstellen eines Übertrags sind fest. Für ein anderes Paar einen neuen Übertrag buchen.',
  ...
  'expenses.transfers.deleted': 'Übertrag gelöscht.',
  ...
  'expenses.col.invoiceDate': 'Rechnungsdatum',
  'expenses.col.paymentDate': 'Zahldatum',
  'expenses.col.correspondent': 'Empfänger/Zahler',
  ...
  'expenses.bookedBy': 'Gebucht von {actor}',
  'expenses.action.viewInvoice': 'Verknüpfte Rechnung anzeigen',
  'expenses.invoice.title': 'Verknüpfte Rechnung',
  'expenses.invoice.noFile': 'Kein Beleg-PDF hinterlegt.',
  ...
  'expenses.field.invoiceDate': 'Rechnungsdatum',
  'expenses.field.paymentDate': 'Zahldatum',
  'expenses.field.correspondent': 'Empfänger/Zahler',
  'expenses.field.correspondentPlaceholder': 'Von wem / für wen?',
  'expenses.field.referenceNumber': 'Belegnummer',
  'expenses.field.paymentMethod': 'Zahlungsmethode',
  'expenses.field.paymentMethodPlaceholder': 'Keine Angabe',
  'expenses.field.category': 'Kategorie',
  'expenses.field.note': 'Anmerkungen',
  'expenses.paymentMethod.ueberweisung': 'Überweisung',
  'expenses.paymentMethod.bar': 'Bar',
  'expenses.paymentMethod.lastschrift': 'Lastschrift',
  'expenses.paymentMethod.karte': 'Karte',
  'expenses.paymentMethod.paypal': 'PayPal',
  ...
  'expenses.bulk.deleteBody': '{count} ausgewählte Buchung(en) wirklich löschen?',
  'expenses.bulk.deleteConfirm': 'Löschen',
  'expenses.bulk.deleteDone': '{count} Buchung(en) gelöscht.',
  'expenses.bulk.deleteError': 'Sammel-Löschung fehlgeschlagen.',
  'expenses.bulk.exportSelected': 'Auswahl exportieren',
  'expenses.bulk.exportTitle': 'Auswahl exportieren',
  'expenses.bulk.exportBody': '{count} ausgewählte Buchung(en) als .xlsx exportieren?',
  'expenses.bulk.exportConfirm': 'Exportieren',
  'expenses.bulk.reassign': 'Umbuchen',
  'expenses.bulk.reassignTitle': 'Auswahl umbuchen',
  'expenses.bulk.reassignHint':
    'Kostenstelle/Kategorie für {count} ausgewählte Buchung(en) setzen. Leere Felder bleiben unverändert. Die Kostenstelle wirkt nur auf eigenständige Buchungen.',
  'expenses.bulk.reassignConfirm': 'Übernehmen',
  ...
  'expenses.sub.inherits': 'Erbt Kostenstelle, HHJ und Art von „{parent}".',
  'expenses.sub.empty': 'Noch keine Unterbuchungen — aus Datei hinzufügen.',
  ...
  'invoices.subtitle': 'Belege verwalten und ZUGFeRD-Rechnungen importieren.',
  'invoices.search': 'Suchen (Nummer, Lieferant)…',
  'invoices.filter.status': 'Status',
  'invoices.filter.all': 'Alle',
  'invoices.filter.grossRange': 'Betrag (Brutto)',
  'invoices.filter.amountMin': 'von',
  'invoices.filter.amountMax': 'bis',
  'invoices.filter.issueRange': 'Rechnungsdatum',
  'invoices.filter.issueFrom': 'Rechnungsdatum von',
  'invoices.filter.issueTo': 'Rechnungsdatum bis',
  'invoices.filter.dueRange': 'Fälligkeitsdatum',
  'invoices.filter.dueFrom': 'Fälligkeitsdatum von',
  'invoices.filter.dueTo': 'Fälligkeitsdatum bis',
  'invoices.import': 'Importieren',
  'invoices.add': 'Rechnung hinzufügen',
  'invoices.edit': 'Rechnung bearbeiten',
  'invoices.loading': 'Rechnungen werden geladen…',
  'invoices.loadingMore': 'Weitere Rechnungen werden geladen …',
  'invoices.loadMore': 'Mehr laden',
  'invoices.count': '{count} von {total}',
  'invoices.empty': 'Keine Rechnungen gefunden.',
  'invoices.drop': 'PDF hier ablegen, um zu importieren',
  'invoices.importReview': 'Importierte Rechnung prüfen',
  'invoices.importedBeleg': 'Beleg angehängt',
  'invoices.openFile': 'Beleg öffnen',
  'invoices.bookedBy': 'Erfasst von {actor}',
  'invoices.col.issueDate': 'Rechnungsdatum',
  'invoices.col.dueDate': 'Fällig',
  'invoices.col.number': 'Nummer',
  'invoices.col.supplier': 'Lieferant',
  'invoices.col.net': 'Netto',
  'invoices.col.tax': 'USt.',
  'invoices.col.gross': 'Brutto',
  'invoices.col.status': 'Status',
  'invoices.col.file': 'Beleg',
  'invoices.status.open': 'Offen',
  'invoices.status.paid': 'Bezahlt',
  'invoices.field.number': 'Rechnungsnummer',
  'invoices.field.supplier': 'Lieferant',
  'invoices.field.issueDate': 'Rechnungsdatum',
  'invoices.field.dueDate': 'Fälligkeitsdatum',
  'invoices.field.net': 'Netto',
  'invoices.field.tax': 'USt.',
  'invoices.field.gross': 'Brutto',
  'invoices.field.status': 'Status',
  'invoices.field.note': 'Notiz',
  'invoices.delete.title': 'Rechnung löschen',
  'invoices.delete.body': 'Rechnung „{number}" wirklich löschen?',
  'invoices.delete.confirm': 'Löschen',
  'invoices.attachBeleg': 'Beleg hinzufügen',
  'invoices.removeBeleg': 'Beleg entfernen',
  'invoices.toast.imported': 'Rechnung gelesen — bitte prüfen.',
  'invoices.toast.notZugferd': 'Kein ZUGFeRD erkannt — bitte manuell erfassen.',
  'invoices.toast.duplicate': 'Mögliche Dublette: Rechnung „{number}" existiert bereits.',
  'invoices.toast.created': 'Rechnung angelegt.',
  ...
  'status.actions.title': 'Aktionen',
  'status.actions.lead': 'Diese Schritte kannst du selbst ausführen.',
  'status.actions.fallback': 'Aktion ausführen',
  'status.actions.failed': 'Aktion fehlgeschlagen.',
  'status.history.title': 'Verlauf',
  'status.history.empty': 'Noch keine Ereignisse.',
  'status.history.by': 'von {actor}',
  'status.history.voteNote': 'Abstimmungsergebnis: {result}',
  ...
  'applications.detail.eraseRequestFailed': 'Löschantrag fehlgeschlagen.',
  'applications.detail.forceStatus': 'Status setzen',
  'applications.detail.forceStatusTitle': 'Status direkt setzen',
  'applications.detail.forceStatusLead':
    'Setzt den Antrag direkt in einen beliebigen Zustand — ohne die normalen Übergänge und Bedingungen. Die Aktion wird protokolliert.',
  'applications.detail.forceStatusField': 'Zielzustand',
  'applications.detail.forceStatusPlaceholder': 'Zustand wählen …',
  'applications.detail.forceStatusReason': 'Begründung',
  'applications.detail.forceStatusReasonPlaceholder': 'Warum wird der Status manuell gesetzt?',
  'applications.detail.forceStatusConfirm': 'Status setzen',
  ...
  'applications.comments.edit': 'Kommentar bearbeiten',
  'applications.comments.editTitle': 'Kommentar bearbeiten',
  'applications.comments.body': 'Text',
  'applications.comments.visibilityLocked':
    'Die Sichtbarkeit bleibt unverändert. Nur der Text lässt sich ändern.',
  'applications.comments.updated': 'Kommentar aktualisiert.',
  'applications.comments.delete': 'Kommentar löschen',
  'applications.comments.deleteTitle': 'Kommentar löschen',
  'applications.comments.deleteConfirm': 'Diesen Kommentar endgültig löschen?',
  'applications.comments.deleted': 'Kommentar gelöscht.',
  ...
  'applications.budget.invalid': 'Zuordnung nicht möglich – Kostenstelle/Haushaltsjahr prüfen.',
  'applications.budget.fiscalYear': 'Haushaltsjahr',
  'applications.budget.fiscalAuto': 'Automatisch (aktives HHJ)',
  'applications.budget.fiscalInactive': 'inaktiv',
  ...
  'applications.attachments.preview': 'Vorschau',
  'applications.attachments.previewClose': 'Vorschau schließen',
  ...
  'meetings.list.searchPlaceholder': 'Sitzungen suchen (Titel, Gremium …)',
  'meetings.list.searchEmpty': 'Keine Sitzungen gefunden.',
  ...
  'meetings.control.needProtokollant': 'Protokollant zuweisen, um die Sitzung zu starten.',
  ...
  'meetings.vote.questionPrefill': 'Soll der Antrag {name} wie beschrieben gefördert werden?',
  ...
  'meetings.vote.majorityRule': 'Mehrheitsregel',
  'meetings.vote.eligibleCount': 'Stimmberechtigte (optional)',
  'meetings.vote.eligibleCountPlaceholder': 'Anzahl (für Quorum)',
  'meetings.vote.quorumPercent': 'Quorum (%) (optional)',
  'meetings.vote.quorumPercentPlaceholder': 'z. B. 50',
  'meetings.vote.quorumHint': 'Leer lassen, um die Standardwerte des Gremiums zu verwenden.',
  ...
  'meetings.protocol.rendering': 'Wird gerendert …',
  'meetings.protocol.final': 'Final',
  'meetings.protocol.pdf': 'PDF öffnen',
  'meetings.protocol.pdfInternal': 'Internes Protokoll',
  'meetings.protocol.pdfPublic': 'Öffentliches Protokoll',
  ...
  'meetings.create.namePrefill': 'Sitzung des {committee} am {date}',
  ...
  'meetings.create.next': 'Weiter',
  'meetings.create.back': 'Zurück',
  'meetings.create.date': 'Geplantes Datum',
  'meetings.create.time': 'Uhrzeit',
  'meetings.create.endTime': 'Ende (optional)',
  'meetings.create.endBeforeStart': 'Die End-Uhrzeit muss nach der Start-Uhrzeit liegen.',
  ...
  'meetings.toast.renderQueued': 'Finalisierung gestartet — das PDF wird im Hintergrund gerendert.',
  ...
  'meetings.viewers.title': 'Live dabei',
  'meetings.viewers.empty': 'Niemand hat die Sitzung gerade geöffnet.',
  ...
  'voting.cast.delegation.blocked':
    'Dein Stimmrecht für diese Sitzung ist an {name} übertragen — {name} stimmt an deiner Stelle ab.',
  'voting.cast.delegation.exercising': 'Du stimmst in Vertretung von {name} ab.',
  'voting.cast.delegation.badge': 'In Vertretung',
  'voting.cast.delegation.ownHeading': 'Deine Stimme',
  'voting.cast.delegation.proxyHeading': 'Als Vertretung für {name}',
  'voting.cast.delegation.proxyChoice': 'Vertretungs-Stimme: {choice}',
  ...
  'voting.delete.action': 'Abstimmung löschen',
  'voting.delete.title': 'Abstimmung löschen',
  'voting.delete.body':
    'Die Abstimmung wird endgültig gelöscht. Das ist nur möglich, solange sie nie geöffnet wurde und keine Stimme abgegeben ist.',
  'voting.delete.done': 'Abstimmung gelöscht.',
  'voting.delete.failed': 'Die Abstimmung konnte nicht gelöscht werden.',
  'voting.delete.forbidden': 'Keine Berechtigung, diese Abstimmung zu löschen.',
  'voting.delete.conflict.meetingBound':
    'Diese Abstimmung gehört zu einer Sitzung. Sie wird dort gelöscht.',
  'voting.delete.conflict.notDraft':
    'Die Abstimmung war bereits geöffnet. Statt zu löschen, brich sie ab.',
  'voting.delete.conflict.hasBallots':
    'Es liegen bereits Stimmen vor. Die Abstimmung lässt sich nicht mehr löschen.',
  'voting.delete.conflict.other':
  ...
  'budget.pie.available': 'Verfügbar je Unter-Kostenstelle',
  'budget.pie.expended': 'Ausgegeben je Unter-Kostenstelle',
  'budget.overview.button': 'Übersicht',
  'budget.overview.title': 'Budget-Übersicht',
  'budget.overview.metric.allocated': 'Zuteilung',
  'budget.overview.metric.available': 'Verfügbar',
  'budget.overview.metric.expended': 'Ausgegeben',
  ...
  'budget.tree.stichtagTitle': 'Stichtag setzen',
  ...
  'budget.tree.fyActive': 'Aktiv',
  'budget.tree.fyEdit': 'Haushaltsjahr bearbeiten',
  'budget.tree.fyEditHint':
    'Der Server leitet Beginn und Ende aus dem Stichtag des Budgets neu ab. Ein inaktives Jahr steht nicht mehr zur Auswahl.',
  'budget.tree.fyDelete': 'Haushaltsjahr löschen',
  'budget.tree.fyDeleteTitle': 'Haushaltsjahr löschen?',
  'budget.tree.fyDeleteConfirm':
    'Das Haushaltsjahr {year} wird gelöscht. Das lässt sich nicht rückgängig machen.',
  // 409-Gründe: der Server nennt genau eine dieser Ursachen.
  ...
  'admin.form.type.gremium_select': 'Gremium-Auswahl',
  'admin.form.type.budget_select': 'Kostenstellen-Auswahl',
  'admin.form.type.email': 'E-Mail',
  'admin.form.type.iban': 'IBAN',
  'admin.form.type.daterange': 'Zeitraum',
  ...
  'admin.flow.terminal': 'Endzustand',
  ...
  'admin.flow.actionType.assignBudgetFromField': 'Budget aus Feld zuweisen',
  ...
  'admin.flow.guardOp.actorIsApplicant': 'Akteur ist Antragsteller:in',
  'admin.flow.guardOp.applicationTypeIs': 'Antragstyp ist',
  'admin.flow.guardOp.attachmentPresent': 'Anhang vorhanden',
  ...
  'admin.flow.list.incoming': 'Eingehend',
  'admin.flow.list.outgoing': 'Ausgehend',
  'admin.flow.list.empty': 'Keine Übergänge.',
  'admin.flow.group.create': 'Gruppieren',
  'admin.flow.group.defaultName': 'Gruppe',
  'admin.flow.group.inspector': 'Gruppe',
  'admin.flow.group.name': 'Name',
  'admin.flow.group.members': 'Schritte',
  'admin.flow.group.subgroups': 'Untergruppen',
  'admin.flow.group.rootCrumb': 'Flow',
  'admin.flow.group.dissolve': 'Gruppe auflösen',
  ...
  'admin.flow.actBudgetField': 'Feld mit Kostenstelle',
  'admin.flow.actBudgetFieldPh': 'Feld-Key (z. B. ziel_kostenstelle)',
  'admin.flow.actBudgetFieldHint':
    'Weist die im genannten Formularfeld (gremium_select/budget_select) gewählte Kostenstelle zu.',
  ...
  'admin.webhook.deleteTitle': 'Webhook löschen?',
  'admin.webhook.deleteConfirm':
    '„{name}“ wird mit seiner Zustellhistorie gelöscht. Das lässt sich nicht rückgängig machen.',
  'admin.webhook.deleted': 'Webhook gelöscht.',
  'admin.webhook.deleteFailed': 'Löschen fehlgeschlagen.',
  // Zustelldiagnose: der Server hält je Webhook nur den jüngsten Versuch fest.
  'admin.webhook.delivery': 'Zustellung',
  'admin.webhook.delivery.title': 'Zustellstatus',
  'admin.webhook.delivery.open': 'Zustellstatus anzeigen',
  'admin.webhook.delivery.state': 'Status',
  'admin.webhook.delivery.reason': 'Ursache',
  'admin.webhook.delivery.responseCode': 'HTTP-Code',
  'admin.webhook.delivery.noResponse': 'keine Antwort',
  'admin.webhook.delivery.attempts': 'Versuche',
  'admin.webhook.delivery.lastAt': 'Letzter Versuch',
  'admin.webhook.delivery.none': 'Für diesen Webhook liegt noch kein Zustellstatus vor.',
  'admin.webhook.delivery.hint':
    'Der Server hält je Webhook den jüngsten Zustellversuch fest: Status, Ursache, HTTP-Code und Anzahl der Versuche. Adressen und Antwortinhalte werden nicht gespeichert.',
  'admin.webhook.delivery.deadHint':
    'Dieser Webhook liegt im Dead-Letter. Alle Wiederholungen sind aufgebraucht. Prüfen Sie die Ziel-URL und speichern Sie den Webhook danach erneut.',
  'admin.webhook.delivery.state.never': 'Noch nie',
  'admin.webhook.delivery.state.pending': 'Läuft',
  'admin.webhook.delivery.state.sent': 'Zugestellt',
  'admin.webhook.delivery.state.dead': 'Fehlgeschlagen',
  'admin.webhook.delivery.reason.delivered': 'Erfolgreich zugestellt.',
  'admin.webhook.delivery.reason.in_progress': 'Die Zustellung läuft noch.',
  'admin.webhook.delivery.reason.no_deliveries': 'Bisher kein Zustellversuch.',
  'admin.webhook.delivery.reason.rejected_by_target': 'Das Ziel hat die Anfrage abgelehnt (4xx).',
  'admin.webhook.delivery.reason.target_server_error': 'Das Ziel meldet einen Serverfehler (5xx).',
  'admin.webhook.delivery.reason.transient_transport_error':
    'Vorübergehender Transportfehler. Der Server versucht es erneut.',
  'admin.webhook.delivery.reason.unreachable_or_blocked':
    'Das Ziel ist nicht erreichbar oder aus Sicherheitsgründen blockiert.',
  'admin.webhook.delivery.reason.unknown': 'Die Ursache ist unbekannt.',
  ...
  'admin.audit.col.message': 'Vorgang',
  'admin.audit.col.data': 'Details',
  ...
  'admin.audit.action.config_revert': 'Konfiguration zurückgenommen',
  ...
  'admin.audit.action.delegation_substitute_add': 'Stellvertreter benannt',
  'admin.audit.action.delegation_substitute_remove': 'Stellvertreter entfernt',
  'admin.audit.action.export': 'Export',
  'admin.audit.action.pii_access': 'PII-Zugriff',
  'admin.audit.action.pii_deletion': 'PII-Löschung',
  'admin.audit.action.pii_export': 'PII-Export',
  'admin.audit.action.anonymization': 'Anonymisierung',
  'admin.audit.action.erasure_requested': 'Löschantrag gestellt',
  'admin.audit.action.erasure_executed': 'Löschung ausgeführt',
  'admin.audit.action.erasure_rejected': 'Löschantrag abgelehnt',
  ...
  'admin.audit.action.vote_delete': 'Abstimmung gelöscht',
  'admin.audit.action.budget_node_create': 'Kostenstelle angelegt',
  ...
  'admin.audit.action.budget_transfer_create': 'Umbuchung vorgenommen',
  'admin.audit.action.budget_invoice_create': 'Rechnung erfasst',
  'admin.audit.action.budget_invoice_update': 'Rechnung geändert',
  'admin.audit.action.budget_invoice_delete': 'Rechnung gelöscht',
  'admin.audit.action.budget_assign': 'Antrag zugeordnet',
  'admin.audit.action.budget_move_fiscal_year': 'Haushaltsjahr verschoben',
  'admin.audit.action.budget_fiscal_year_delete': 'Haushaltsjahr gelöscht',
  'admin.audit.today': 'Heute',
  'admin.audit.yesterday': 'Gestern',
  'admin.audit.openTarget': 'Ziel öffnen',
  'admin.audit.detail.action': 'Aktion',
  'admin.audit.detail.target': 'Ziel',
  'admin.audit.detail.actor': 'Akteur',
  'admin.audit.targetType.gremium': 'Gremium',
  'admin.audit.targetType.application': 'Antrag',
  'admin.audit.targetType.application_type': 'Antragstyp',
  'admin.audit.targetType.vote': 'Abstimmung',
  'admin.audit.targetType.role': 'Rolle',
  'admin.audit.targetType.role_assignment': 'Rollenzuweisung',
  'admin.audit.targetType.principal': 'Benutzer',
  'admin.audit.targetType.group_mapping': 'Gruppen-Mapping',
  'admin.audit.targetType.webhook': 'Webhook',
  'admin.audit.targetType.site_config': 'Branding',
  'admin.audit.targetType.budget': 'Kostenstelle',
  'admin.audit.targetType.budget_allocation': 'Mittel-Zuteilung',
  ...
  'admin.config.diff.removed': 'Entfernt',
  'admin.config.history.title': 'Versionen',
  'admin.config.history.empty': 'Noch keine Versionen.',
  'admin.config.history.version': 'Version {version}',
  'admin.config.history.current': 'Aktiv',
  'admin.config.history.viewDiff': 'Änderungen',
  'admin.config.history.restore': 'Wiederherstellen',
  'admin.config.restore.title': 'Version wiederherstellen?',
  'admin.config.restore.confirm':
    'Version {version} wird als neue aktive Version übernommen. Frühere Versionen bleiben erhalten.',
  'admin.config.restore.success': 'Version {version} wiederhergestellt.',
  'admin.config.restore.error': 'Wiederherstellen fehlgeschlagen.',
  ...
  'admin.audit.msg.delegation_substitute_add':
    '{actor} hat einen Stellvertreter benannt ({target}).',
  'admin.audit.msg.delegation_substitute_remove':
    '{actor} hat einen Stellvertreter entfernt ({target}).',
  ...
  'admin.audit.msg.pii_export': '{actor} hat eine Datenauskunft exportiert ({target}).',
  'admin.audit.msg.anonymization': '{actor} hat Daten anonymisiert ({target}).',
  'admin.audit.msg.erasure_requested': '{actor} hat einen Löschantrag gestellt ({target}).',
  'admin.audit.msg.erasure_executed': '{actor} hat einen Löschantrag ausgeführt ({target}).',
  'admin.audit.msg.erasure_rejected': '{actor} hat einen Löschantrag abgelehnt ({target}).',
  'admin.audit.msg.principal_erased': '{actor} hat ein Konto gelöscht ({target}).',
  ...
  'admin.audit.msg.vote_delete': '{actor} hat eine Abstimmung gelöscht ({target}).',
  'admin.audit.msg.budget_node_create': '{actor} hat eine Kostenstelle angelegt ({target}).',
  ...
  'admin.audit.msg.budget_transfer_create': '{actor} hat eine Umbuchung vorgenommen ({target}).',
  'admin.audit.msg.budget_invoice_create': '{actor} hat eine Rechnung erfasst ({target}).',
  'admin.audit.msg.budget_invoice_update': '{actor} hat eine Rechnung geändert ({target}).',
  'admin.audit.msg.budget_invoice_delete': '{actor} hat eine Rechnung gelöscht ({target}).',
  ...
  'admin.privacy.queueEmpty': 'Keine Löschanträge.',
  'admin.privacy.col.status': 'Status',
  'admin.privacy.col.subject': 'Betrifft',
  'admin.privacy.col.email': 'E-Mail',
  'admin.privacy.col.created': 'Eingegangen',
  'admin.privacy.execute': 'Ausführen',
  'admin.privacy.reject': 'Ablehnen',
  'admin.privacy.executeTitle': 'Löschung ausführen',
  'admin.privacy.executeConfirm':
    'Diesen Löschantrag jetzt ausführen? Die personenbezogenen Daten werden anonymisiert bzw. gelöscht — das kann nicht rückgängig gemacht werden.',
  'admin.privacy.executed': 'Löschantrag ausgeführt.',
  'admin.privacy.rejectTitle': 'Löschantrag ablehnen',
  'admin.privacy.rejectReason': 'Grund (optional)',
  'admin.privacy.rejected': 'Löschantrag abgelehnt.',
  'admin.privacy.status.open': 'Offen',
  'admin.privacy.status.executed': 'Ausgeführt',
  'admin.privacy.status.rejected': 'Abgelehnt',
  'admin.privacy.subject.applicant': 'Antrag',
  'admin.privacy.subject.principal': 'Konto',
  'admin.privacy.auskunftTitle': 'Auskunft (Art. 15)',
  'admin.privacy.auskunftHint': 'Alle zu einer E-Mail gespeicherten Daten als XLSX exportieren.',
  'admin.privacy.email': 'E-Mail-Adresse',
  'admin.privacy.auskunftExport': 'Exportieren',
  'admin.privacy.auskunftDone': 'Auskunft exportiert.',
  'admin.privacy.principalTitle': 'Konto löschen (Art. 17)',
  'admin.privacy.principalHint':
    'Personenbezogene Daten eines Principals leeren (Sub bleibt als Pseudonym).',
  'admin.privacy.principalId': 'Principal-ID (UUID)',
  'admin.privacy.principalErase': 'Konto löschen',
  'admin.privacy.principalConfirm':
    'Die personenbezogenen Daten dieses Kontos endgültig löschen? Das kann nicht rückgängig gemacht werden.',
  'admin.privacy.principalErased': 'Konto gelöscht.',
  'admin.privacy.retentionTitle': 'Aufbewahrung (Art. 5(1)(e))',
  'admin.privacy.retentionHint':
    'Globaler Standard in Monaten, bis terminale Anträge anonymisiert werden.',
  'admin.privacy.retentionMonths': 'Aufbewahrung (Monate)',
  ...
  'admin.cdVariants.loading': 'CD-Varianten werden geladen…',
  'admin.cdVariants.error': 'CD-Varianten konnten nicht geladen werden.',
  'admin.cdVariants.empty': 'Noch keine CD-Varianten angelegt.',
  'admin.cdVariants.name': 'Name',
  'admin.cdVariants.keyHint':
    'Wird aus dem Namen erzeugt. Nach dem Anlegen ist er nicht mehr änderbar.',
  'admin.cdVariants.keyLocked': 'Der Schlüssel ist unveränderlich.',
  ...
  'admin.cdVariants.col.base': 'Basis',
  'admin.cdVariants.col.logos': 'Logos',
  'admin.cdVariants.toggleLogos': 'Logos anzeigen',
  'admin.cdVariants.slot': 'Position',
  'admin.cdVariants.slot.title': 'Titelseite',
  'admin.cdVariants.slot.footer': 'Fußzeile',
  'admin.cdVariants.noLogos': 'Noch keine Logos.',
  ...
  'admin.cdVariants.vendored': 'mitgeliefert',
  'admin.cdVariants.uploaded': 'hochgeladen',
  ...
  'admin.cdVariants.deleteTitle': 'CD-Variante löschen',
  'admin.cdVariants.deleteConfirm': '„{name}" wirklich löschen?',
  ...
  'admin.deleg.loading': 'Delegationen werden geladen …',
  'admin.deleg.error': 'Delegationen konnten nicht geladen werden.',
  'admin.deleg.none': 'Keine Delegationen vorhanden.',
  'admin.deleg.meeting': 'Sitzung',
  'admin.deleg.who': 'Vertretung',
  'admin.deleg.flags': 'Eigenschaften',
  'admin.deleg.actions': 'Aktionen',
  'admin.deleg.revoke': 'Widerrufen',
  'admin.deleg.revokeTitle': 'Delegation widerrufen',
  'admin.deleg.revokeConfirm': 'Delegation an „{name}“ wirklich widerrufen?',
  'admin.deleg.cancel': 'Abbrechen',
  ...
  'admin.substitutes.add': 'Stellvertreter hinzufügen',
  'admin.substitutes.addAction': 'Hinzufügen',
  'admin.substitutes.search': 'Person suchen',
  'admin.substitutes.forMember': 'Vertritt',
  'admin.substitutes.allMembers': 'Alle Mitglieder',
  'admin.substitutes.empty': 'Keine Stellvertreter benannt.',
  'admin.substitutes.col.substitute': 'Stellvertreter',
  'admin.substitutes.col.member': 'Vertritt',
  'admin.substitutes.remove': 'Stellvertreter entfernen',
  'admin.substitutes.added': 'Stellvertreter hinzugefügt.',
  'admin.substitutes.removed': 'Stellvertreter entfernt.',
  ...
  'delegation.card.deadline': 'Einrichtbar bis {date}.',
  'delegation.card.deadlinePassed':
    'Die Frist ist abgelaufen — nur noch Stellvertreter aus dem Pool sind möglich.',
  'delegation.card.setup': 'Vertretung einrichten',
  'delegation.card.outgoing': 'Du wirst vertreten von {name}.',
  'delegation.card.incoming': 'Du vertrittst {name} in dieser Sitzung.',
  ...
  'delegation.dialog.search': 'Person suchen',
  'delegation.dialog.searchPlaceholder': 'Name oder E-Mail …',
  'delegation.dialog.poolSuffix': '(Stellvertreter)',
  'delegation.dialog.poolHint':
    'Stellvertreter aus dem Pool — ohne Vorlauf bis Sitzungsbeginn möglich.',
  'delegation.dialog.externalHint':
    'Externe Person (kein Gremium-Mitglied) — zulässig, da dieses Gremium externe Vertretungen erlaubt.',
  'delegation.dialog.voting': 'Stimmrecht mit übertragen',
  'delegation.dialog.votingHint':
    'Dein Vertreter stimmt an deiner Stelle ab; du selbst bist für Abstimmungen dieser Sitzung gesperrt.',
  'delegation.dialog.votingDisabled':
  ...
  'delegation.dash.subtitle': 'Deine sitzungsgebundenen Vertretungen.',
  'delegation.dash.outgoing': 'Du wirst vertreten von {name}',
  'delegation.dash.incoming': 'Du vertrittst {name}',
  ...
  'admin.forms.delete': 'Antragsart löschen',
  'admin.forms.deleteConfirm':
  ...
  'admin.forms.cmpRequired': 'Vergleichsangebote erforderlich',
  'admin.forms.cmpRequiredHint': 'Antragsteller müssen Vergleichsangebote beilegen.',
  'admin.forms.cmpMinCount': 'Mindestanzahl',
  ...
  'admin.gremien.cdVariantNone': '— (Standard von pytex)',
  'admin.gremien.cdVariantHint':
    'Legt die Logos der gerenderten Dokumente fest. Varianten werden unter „CD-Varianten" gepflegt.',
  ...
  'admin.gremien.delegationHint':
    'Mitglieder dürfen sich für einzelne Sitzungen dieses Gremiums vertreten lassen.',
  'admin.gremien.delegationLead': 'Vorlauf für Delegationen (Minuten)',
  'admin.gremien.delegationLeadHint':
    'Bis so viele Minuten vor Sitzungsbeginn ist eine Vertretung einrichtbar (0 = bis Beginn). Stellvertreter aus dem Pool sind vom Vorlauf ausgenommen.',
  'admin.gremien.delegationExternal': 'Delegation an Externe erlauben',
  'admin.gremien.delegationExternalHint':
    'Auch Nutzer außerhalb von Gremium und Stellvertreter-Pool dürfen als Vertretung gewählt werden.',
  ...
  'admin.gremien.memberEdit': 'Mitgliedschaft bearbeiten',
  'admin.gremien.memberEditFor': 'Mitglied',
  'admin.gremien.memberSaved': 'Mitgliedschaft gespeichert.',
  'admin.gremien.memberTermHint':
    'Person und Gremium bleiben unverändert. Ein leeres Feld lässt die Amtszeit an diesem Ende offen.',
  'admin.gremien.memberBadTerm': 'Das Von-Datum muss vor dem Bis-Datum liegen.',
  ...
  'admin.users.editAssignment': 'Zuweisung bearbeiten',
  'admin.users.editHint':
    'Ein leeres Datumsfeld bleibt unverändert. Eine gesetzte Gültigkeit lässt sich hier nicht entfernen: dafür die Rolle entziehen und neu zuweisen.',
  'admin.users.editSaved': 'Zuweisung aktualisiert.',
  'admin.users.editFailed': 'Zuweisung konnte nicht geändert werden.',
  'admin.users.editSelfBlocked': 'Die eigene Admin-Zuweisung lässt sich nicht ändern.',
  ...
  'admin.mailTemplates.subtitle':
    'Betreff, Text und HTML der Benachrichtigungs-Mails je Sprache bearbeiten (Jinja2-Platzhalter).',
  'admin.mailTemplates.empty': 'Keine Vorlagen vorhanden.',
  'admin.mailTemplates.selectHint': 'Links eine Vorlage zum Bearbeiten wählen.',
  'admin.mailTemplates.key.magic_link': 'Anmelde-Link',
  'admin.mailTemplates.key.status_update': 'Status-Änderung',
  'admin.mailTemplates.key.status_update_team': 'Status-Änderung (Team)',
  'admin.mailTemplates.key.deadline_approaching': 'Frist-Erinnerung',
  'admin.mailTemplates.key.task_new': 'Neue Aufgabe',
  'admin.mailTemplates.key.task_reminder': 'Aufgaben-Erinnerung',
  'admin.mailTemplates.key.comment_applicant': 'Kommentar (Antragsteller:in)',
  'admin.mailTemplates.key.comment_team': 'Kommentar (Team)',
  'admin.mailTemplates.key.meeting_created': 'Neue Sitzung',
  'admin.mailTemplates.key.role_assigned': 'Rolle zugewiesen',
  'admin.mailTemplates.key.role_revoked': 'Rolle entzogen',
  'admin.mailTemplates.key.delegation_granted': 'Vertretung erhalten',
  'admin.mailTemplates.key.delegation_revoked': 'Vertretung widerrufen',
  'admin.mailTemplates.customized': 'angepasst',
  'admin.mailTemplates.reset': 'Auf Standard zurücksetzen',
  'admin.mailTemplates.resetDone': 'Auf Standard zurückgesetzt.',
  'admin.mailTemplates.subject': 'Betreff',
  'admin.mailTemplates.body': 'Text',
  'admin.mailTemplates.bodyHtml': 'HTML (optional)',
  'admin.mailTemplates.bodyHtmlPlaceholder': 'Leer lassen für reine Text-Mail',
  'admin.mailTemplates.placeholders': 'Platzhalter',
  'admin.mailTemplates.preview': 'Vorschau',
  'admin.mailTemplates.previewHeading': 'Vorschau',
  'admin.mailTemplates.saved': 'Vorlage gespeichert.',
  'admin.mailTemplates.failed': 'Speichern fehlgeschlagen.',
...
export const en: Partial<Record<TranslationKey, string>> = {
  ...
  'account.calendar.urlLabel': 'Feed URL',
  'account.calendar.copy': 'Copy',
  'account.calendar.copied': 'Copied!',
  'account.calendar.none': 'No feed link created yet.',
  'account.calendar.generate': 'Create feed link',
  ...
  'account.notifications.hint.comment': 'When an application that concerns you receives a comment.',
  'account.notifications.kind.task': 'New tasks',
  'account.notifications.hint.task': 'When an application reaches a step where you can act.',
  ...
  'account.notifications.hint.meeting': 'Invitations and agendas of your committees’ meetings.',
  ...
  'account.notifications.hint.role_change': 'When a role is assigned to you or revoked.',
  'account.notifications.kind.delegation': 'Delegations',
  'account.notifications.hint.delegation': 'When you receive a vote delegation or it is revoked.',
  ...
  'account.grants.active': 'Active grants',
  'account.grants.empty': 'No active grants.',
  'account.grants.error': 'Could not load grants.',
  'account.grants.scope': 'Scope',
  'account.grants.created': 'Created',
  'account.grants.expires': 'Expires',
  'account.grants.revoke': 'Revoke',
  'account.grants.revokeAll': 'Revoke all',
  'account.mcp.title': 'MCP server',
  'account.mcp.intro':
    'Download the MCP server that lets agents use the platform API. The package is pre-configured for this platform.',
  'account.mcp.download': 'Download MCP package',
  'account.mcp.step1': 'Unpack the archive.',
  'account.mcp.step3': "Add the following entry to your client's MCP configuration:",
  'account.mcp.config': 'MCP configuration',
  'account.mcp.wired': 'Pre-configured platform URL',
  'account.grants.never': 'Never expires',
  'account.consent.title': 'Authorize access',
  'account.consent.intro':
    'An agent (MCP) wants to act on your behalf. Choose its scope and how long the access lasts.',
  'account.consent.scopes': 'Permissions',
  'account.consent.lifetime': 'Lifetime',
  'account.consent.approve': 'Allow',
  'account.consent.deny': 'Deny',
  'account.consent.error': 'Could not process the request.',
  'account.consent.notAllowed': 'You lack the "mcp.use" permission for API agents.',
  'account.consent.notHeld': "You don't currently hold this right — the agent won't get it.",
  'account.lifetime.1h': '1 hour',
  'account.lifetime.8h': '8 hours',
  'account.lifetime.1d': '1 day',
  'account.lifetime.30d': '30 days',
  'account.lifetime.90d': '90 days',
  'account.lifetime.never': 'Never expires',
  ...
  'account.scope.forms_write.desc': 'Create and activate form versions.',
  'account.scope.flows_write.label': 'Edit workflows',
  'account.scope.flows_write.desc': 'Change flow definitions (states/transitions).',
  'account.scope.admin_write.label': 'Administration',
  'account.scope.admin_write.desc': 'Manage committees, roles, permissions, and webhooks.',
  ...
  'expenses.transferToast': 'Transfer booked.',
  'expenses.tab.bookings': 'Bookings',
  'expenses.tab.transfers': 'Transfers',
  'expenses.transfers.from': 'From',
  'expenses.transfers.to': 'To',
  'expenses.transfers.empty': 'No transfers found.',
  'expenses.transfers.editTitle': 'Edit transfer',
  'expenses.transfers.pairLocked':
    'The two cost centres of a transfer are fixed. For a different pair, book a new transfer.',
  ...
  'expenses.transfers.deleted': 'Transfer deleted.',
  ...
  'expenses.col.invoiceDate': 'Invoice date',
  'expenses.col.paymentDate': 'Payment date',
  'expenses.col.correspondent': 'Payee/Payer',
  ...
  'expenses.bookedBy': 'Booked by {actor}',
  'expenses.action.viewInvoice': 'View linked invoice',
  'expenses.invoice.title': 'Linked invoice',
  'expenses.invoice.noFile': 'No receipt PDF attached.',
  ...
  'expenses.field.invoiceDate': 'Invoice date',
  'expenses.field.paymentDate': 'Payment date',
  'expenses.field.correspondent': 'Payee/Payer',
  'expenses.field.correspondentPlaceholder': 'From whom / for whom?',
  'expenses.field.referenceNumber': 'Reference no.',
  'expenses.field.paymentMethod': 'Payment method',
  'expenses.field.paymentMethodPlaceholder': 'Not specified',
  'expenses.field.category': 'Category',
  'expenses.field.note': 'Notes',
  'expenses.paymentMethod.ueberweisung': 'Bank transfer',
  'expenses.paymentMethod.bar': 'Cash',
  'expenses.paymentMethod.lastschrift': 'Direct debit',
  'expenses.paymentMethod.karte': 'Card',
  'expenses.paymentMethod.paypal': 'PayPal',
  ...
  'expenses.bulk.deleteBody': 'Really delete {count} selected booking(s)?',
  'expenses.bulk.deleteConfirm': 'Delete',
  'expenses.bulk.deleteDone': '{count} booking(s) deleted.',
  'expenses.bulk.deleteError': 'Bulk deletion failed.',
  'expenses.bulk.exportSelected': 'Export selection',
  'expenses.bulk.exportTitle': 'Export selection',
  'expenses.bulk.exportBody': 'Export {count} selected booking(s) as .xlsx?',
  'expenses.bulk.exportConfirm': 'Export',
  'expenses.bulk.reassign': 'Reassign',
  'expenses.bulk.reassignTitle': 'Reassign selection',
  'expenses.bulk.reassignHint':
    'Set cost centre/category for {count} selected booking(s). Empty fields stay unchanged. The cost centre applies to standalone bookings only.',
  'expenses.bulk.reassignConfirm': 'Apply',
  ...
  'expenses.sub.inherits': 'Inherits cost-centre, fiscal year and kind from “{parent}”.',
  'expenses.sub.empty': 'No sub-bookings yet — add from a file.',
  ...
  'invoices.subtitle': 'Manage receipts and import ZUGFeRD invoices.',
  'invoices.search': 'Search (number, supplier)…',
  'invoices.filter.status': 'Status',
  'invoices.filter.all': 'All',
  'invoices.filter.grossRange': 'Amount (gross)',
  'invoices.filter.amountMin': 'from',
  'invoices.filter.amountMax': 'to',
  'invoices.filter.issueRange': 'Invoice date',
  'invoices.filter.issueFrom': 'Invoice date from',
  'invoices.filter.issueTo': 'Invoice date to',
  'invoices.filter.dueRange': 'Due date',
  'invoices.filter.dueFrom': 'Due date from',
  'invoices.filter.dueTo': 'Due date to',
  'invoices.import': 'Import',
  'invoices.add': 'Add invoice',
  'invoices.edit': 'Edit invoice',
  'invoices.loading': 'Loading invoices…',
  'invoices.loadingMore': 'Loading more invoices …',
  'invoices.loadMore': 'Load more',
  'invoices.count': '{count} of {total}',
  'invoices.empty': 'No invoices found.',
  'invoices.drop': 'Drop a PDF here to import',
  'invoices.importReview': 'Review imported invoice',
  'invoices.importedBeleg': 'Receipt attached',
  'invoices.openFile': 'Open receipt',
  'invoices.bookedBy': 'Entered by {actor}',
  'invoices.col.issueDate': 'Invoice date',
  'invoices.col.dueDate': 'Due',
  'invoices.col.number': 'Number',
  'invoices.col.supplier': 'Supplier',
  'invoices.col.net': 'Net',
  'invoices.col.tax': 'VAT',
  'invoices.col.gross': 'Gross',
  'invoices.col.status': 'Status',
  'invoices.col.file': 'Receipt',
  'invoices.status.open': 'Open',
  'invoices.status.paid': 'Paid',
  'invoices.field.number': 'Invoice number',
  'invoices.field.supplier': 'Supplier',
  'invoices.field.issueDate': 'Invoice date',
  'invoices.field.dueDate': 'Due date',
  'invoices.field.net': 'Net',
  'invoices.field.tax': 'VAT',
  'invoices.field.gross': 'Gross',
  'invoices.field.status': 'Status',
  'invoices.field.note': 'Note',
  'invoices.delete.title': 'Delete invoice',
  'invoices.delete.body': 'Really delete invoice “{number}”?',
  'invoices.delete.confirm': 'Delete',
  'invoices.attachBeleg': 'Attach receipt',
  'invoices.removeBeleg': 'Remove receipt',
  'invoices.toast.imported': 'Invoice parsed — please review.',
  'invoices.toast.notZugferd': 'No ZUGFeRD detected — please enter manually.',
  'invoices.toast.duplicate': 'Possible duplicate: invoice “{number}” already exists.',
  ...
  'status.actions.title': 'Actions',
  'status.actions.lead': 'You can take these steps yourself.',
  'status.actions.fallback': 'Run action',
  'status.actions.failed': 'Action failed.',
  'status.history.title': 'History',
  'status.history.empty': 'No events yet.',
  'status.history.by': 'by {actor}',
  'status.history.voteNote': 'Vote result: {result}',
  ...
  'applications.detail.eraseRequestFailed': 'Erasure request failed.',
  'applications.detail.forceStatus': 'Set status',
  'applications.detail.forceStatusTitle': 'Set status directly',
  'applications.detail.forceStatusLead':
    'Move the application straight into any state — bypassing the normal transitions and conditions. The action is recorded in the audit log.',
  'applications.detail.forceStatusField': 'Target state',
  'applications.detail.forceStatusPlaceholder': 'Choose a state …',
  'applications.detail.forceStatusReason': 'Reason',
  'applications.detail.forceStatusReasonPlaceholder': 'Why is the status being set manually?',
  'applications.detail.forceStatusConfirm': 'Set status',
  ...
  'applications.comments.edit': 'Edit comment',
  'applications.comments.editTitle': 'Edit comment',
  'applications.comments.body': 'Text',
  'applications.comments.visibilityLocked':
    'The visibility stays as it is. Only the text can change.',
  'applications.comments.updated': 'Comment updated.',
  'applications.comments.delete': 'Delete comment',
  'applications.comments.deleteTitle': 'Delete comment',
  'applications.comments.deleteConfirm': 'Delete this comment permanently?',
  'applications.comments.deleted': 'Comment deleted.',
  'applications.comments.forbidden':
  ...
  'applications.budget.invalid': 'Assignment not allowed – check cost centre / fiscal year.',
  'applications.budget.fiscalYear': 'Fiscal year',
  'applications.budget.fiscalAuto': 'Automatic (active fiscal year)',
  'applications.budget.fiscalInactive': 'inactive',
  ...
  'applications.attachments.preview': 'Preview',
  'applications.attachments.previewClose': 'Close preview',
  'applications.attachments.delete': 'Delete attachment',
  'applications.attachments.deleted': 'Attachment deleted.',
  'applications.attachments.deleteError': 'Could not delete the attachment.',
  ...
  'meetings.list.searchPlaceholder': 'Search meetings (title, committee …)',
  'meetings.list.searchEmpty': 'No meetings found.',
  ...
  'meetings.agenda.nonPublic': 'Non-public',
  ...
  'meetings.control.needProtokollant': 'Assign a minute-taker to start the meeting.',
  ...
  'meetings.vote.progressHidden': 'The tally appears once all present members have voted.',
  ...
  'meetings.vote.questionPrefill': 'Should the application {name} be funded as described?',
  ...
  'meetings.vote.majorityRule': 'Majority rule',
  'meetings.vote.eligibleCount': 'Eligible voters (optional)',
  'meetings.vote.eligibleCountPlaceholder': 'Count (for quorum)',
  'meetings.vote.quorumPercent': 'Quorum (%) (optional)',
  'meetings.vote.quorumPercentPlaceholder': 'e.g. 50',
  'meetings.vote.quorumHint': 'Leave empty to use the committee defaults.',
  ...
  'meetings.protocol.rendering': 'Rendering …',
  'meetings.protocol.final': 'Final',
  'meetings.protocol.pdf': 'Open PDF',
  'meetings.protocol.pdfInternal': 'Internal minutes',
  'meetings.protocol.pdfPublic': 'Public minutes',
  ...
  'meetings.create.namePrefill': '{committee} meeting on {date}',
  ...
  'meetings.create.next': 'Next',
  'meetings.create.back': 'Back',
  'meetings.create.date': 'Planned date',
  'meetings.create.time': 'Time',
  'meetings.create.endTime': 'End (optional)',
  'meetings.create.endBeforeStart': 'The end time must be after the start time.',
  ...
  'meetings.toast.renderQueued': 'Finalization started — the PDF is rendered in the background.',
  ...
  'meetings.viewers.title': 'Viewing live',
  'meetings.viewers.empty': 'Nobody has the session open right now.',
  ...
  'voting.cast.delegation.blocked':
    'Your voting right for this meeting has been transferred to {name} — {name} votes on your behalf.',
  'voting.cast.delegation.exercising': 'You are voting on behalf of {name}.',
  'voting.cast.delegation.badge': 'By proxy',
  'voting.cast.delegation.ownHeading': 'Your vote',
  'voting.cast.delegation.proxyHeading': 'As proxy for {name}',
  'voting.cast.delegation.proxyChoice': 'Proxy vote: {choice}',
  ...
  'voting.delete.action': 'Delete vote',
  'voting.delete.title': 'Delete vote',
  'voting.delete.body':
    'The vote is deleted permanently. This works only while it never opened and holds no ballot.',
  'voting.delete.done': 'Vote deleted.',
  'voting.delete.failed': 'Could not delete the vote.',
  'voting.delete.forbidden': 'No permission to delete this vote.',
  'voting.delete.conflict.meetingBound':
  ...
  'budget.pie.available': 'Available per sub-cost-centre',
  'budget.pie.expended': 'Spent per sub-cost-centre',
  'budget.overview.button': 'Overview',
  'budget.overview.title': 'Budget overview',
  'budget.overview.metric.allocated': 'Allocation',
  'budget.overview.metric.available': 'Available',
  'budget.overview.metric.expended': 'Spent',
  'budget.overview.hint':
  ...
  'budget.tree.stichtagTitle': 'Set cutoff date',
  ...
  'budget.tree.fyActive': 'Active',
  'budget.tree.fyEdit': 'Edit fiscal year',
  'budget.tree.fyEditHint':
    'The server derives the start and the end date again from the budget cutoff. An inactive year is no longer offered for selection.',
  'budget.tree.fyDelete': 'Delete fiscal year',
  'budget.tree.fyDeleteTitle': 'Delete fiscal year?',
  'budget.tree.fyDeleteConfirm': 'The fiscal year {year} is deleted. You cannot undo this.',
  // 409 reasons: the server names exactly one of these causes.
  'budget.tree.fyBlocked.bookings':
  ...
  'admin.form.type.gremium_select': 'Committee picker',
  'admin.form.type.budget_select': 'Cost-centre picker',
  'admin.form.type.email': 'E-mail',
  'admin.form.type.iban': 'IBAN',
  'admin.form.type.daterange': 'Date range',
  ...
  'admin.flow.actionType.assignBudgetFromField': 'Assign budget from field',
  ...
  'admin.flow.guardOp.actorIsApplicant': 'Actor is the applicant',
  'admin.flow.guardOp.applicationTypeIs': 'Application type is',
  'admin.flow.guardOp.attachmentPresent': 'Attachment present',
  ...
  'admin.flow.list.incoming': 'Incoming',
  'admin.flow.list.outgoing': 'Outgoing',
  'admin.flow.list.empty': 'No transitions.',
  'admin.flow.group.create': 'Group',
  'admin.flow.group.defaultName': 'Group',
  'admin.flow.group.inspector': 'Group',
  'admin.flow.group.name': 'Name',
  'admin.flow.group.members': 'steps',
  'admin.flow.group.subgroups': 'subgroups',
  'admin.flow.group.rootCrumb': 'Flow',
  'admin.flow.group.dissolve': 'Dissolve group',
  'admin.flow.group.dissolveHint':
  ...
  'admin.flow.actBudgetField': 'Field holding the cost centre',
  'admin.flow.actBudgetFieldPh': 'Field key (e.g. ziel_kostenstelle)',
  'admin.flow.actBudgetFieldHint':
    'Assigns the cost centre chosen in the named form field (gremium_select/budget_select).',
  ...
  'admin.webhook.deleteTitle': 'Delete webhook?',
  'admin.webhook.deleteConfirm':
    '“{name}” is deleted together with its delivery history. You cannot undo this.',
  'admin.webhook.deleted': 'Webhook deleted.',
  'admin.webhook.deleteFailed': 'Delete failed.',
  // Delivery diagnosis: the server keeps only the newest attempt per webhook.
  'admin.webhook.delivery': 'Delivery',
  'admin.webhook.delivery.title': 'Delivery status',
  'admin.webhook.delivery.open': 'Show the delivery status',
  'admin.webhook.delivery.state': 'Status',
  'admin.webhook.delivery.reason': 'Reason',
  'admin.webhook.delivery.responseCode': 'HTTP code',
  'admin.webhook.delivery.noResponse': 'no response',
  'admin.webhook.delivery.attempts': 'Attempts',
  'admin.webhook.delivery.lastAt': 'Last attempt',
  'admin.webhook.delivery.none': 'There is no delivery status for this webhook yet.',
  'admin.webhook.delivery.hint':
    'The server keeps the newest delivery attempt per webhook: status, reason, HTTP code and the number of attempts. It stores no addresses and no response bodies.',
  'admin.webhook.delivery.deadHint':
    'This webhook is in the dead-letter state. All retries are used up. Check the target URL, then save the webhook again.',
  'admin.webhook.delivery.state.never': 'Never',
  'admin.webhook.delivery.state.pending': 'In progress',
  'admin.webhook.delivery.state.sent': 'Delivered',
  'admin.webhook.delivery.state.dead': 'Failed',
  'admin.webhook.delivery.reason.delivered': 'Delivered successfully.',
  'admin.webhook.delivery.reason.in_progress': 'The delivery is still in progress.',
  'admin.webhook.delivery.reason.no_deliveries': 'No delivery attempt yet.',
  'admin.webhook.delivery.reason.rejected_by_target': 'The target rejected the request (4xx).',
  'admin.webhook.delivery.reason.target_server_error': 'The target reports a server error (5xx).',
  'admin.webhook.delivery.reason.transient_transport_error':
    'Temporary transport error. The server tries again.',
  'admin.webhook.delivery.reason.unreachable_or_blocked':
    'The target is unreachable, or it is blocked for security reasons.',
  'admin.webhook.delivery.reason.unknown': 'The reason is unknown.',
  ...
  'admin.audit.action.config_revert': 'Configuration reverted',
  ...
  'admin.audit.action.delegation_substitute_add': 'Substitute designated',
  'admin.audit.action.delegation_substitute_remove': 'Substitute removed',
  'admin.audit.action.export': 'Export',
  'admin.audit.action.pii_access': 'PII access',
  'admin.audit.action.pii_deletion': 'PII deletion',
  'admin.audit.action.pii_export': 'PII export',
  'admin.audit.action.anonymization': 'Anonymisation',
  'admin.audit.action.erasure_requested': 'Erasure requested',
  'admin.audit.action.erasure_executed': 'Erasure executed',
  'admin.audit.action.erasure_rejected': 'Erasure rejected',
  ...
  'admin.audit.action.vote_delete': 'Vote deleted',
  'admin.audit.action.budget_node_create': 'Cost centre created',
  ...
  'admin.audit.action.budget_transfer_create': 'Transfer made',
  'admin.audit.action.budget_invoice_create': 'Invoice recorded',
  'admin.audit.action.budget_invoice_update': 'Invoice updated',
  'admin.audit.action.budget_invoice_delete': 'Invoice deleted',
  'admin.audit.action.budget_assign': 'Application assigned',
  'admin.audit.action.budget_move_fiscal_year': 'Fiscal year moved',
  'admin.audit.action.budget_fiscal_year_delete': 'Fiscal year deleted',
  ...
  'admin.audit.targetType.gremium': 'Committee',
  'admin.audit.targetType.application': 'Application',
  'admin.audit.targetType.application_type': 'Application type',
  'admin.audit.targetType.vote': 'Vote',
  'admin.audit.targetType.role': 'Role',
  'admin.audit.targetType.role_assignment': 'Role assignment',
  'admin.audit.targetType.principal': 'User',
  'admin.audit.targetType.group_mapping': 'Group mapping',
  'admin.audit.targetType.webhook': 'Webhook',
  'admin.audit.targetType.site_config': 'Branding',
  'admin.audit.targetType.budget': 'Cost centre',
  'admin.audit.targetType.budget_allocation': 'Allocation',
  ...
  'admin.config.diff.removed': 'Removed',
  'admin.config.history.title': 'Versions',
  'admin.config.history.empty': 'No versions yet.',
  'admin.config.history.version': 'Version {version}',
  'admin.config.history.current': 'Active',
  'admin.config.history.viewDiff': 'Changes',
  'admin.config.history.restore': 'Restore',
  'admin.config.restore.title': 'Restore version?',
  'admin.config.restore.confirm':
    'Version {version} will become the new active version. Earlier versions are kept.',
  'admin.config.restore.success': 'Version {version} restored.',
  'admin.config.restore.error': 'Restore failed.',
  ...
  'admin.audit.msg.delegation_substitute_add': '{actor} designated a substitute ({target}).',
  'admin.audit.msg.delegation_substitute_remove': '{actor} removed a substitute ({target}).',
  ...
  'admin.audit.msg.pii_export': '{actor} exported a data subject access report ({target}).',
  'admin.audit.msg.anonymization': '{actor} anonymised data ({target}).',
  'admin.audit.msg.erasure_requested': '{actor} submitted an erasure request ({target}).',
  'admin.audit.msg.erasure_executed': '{actor} executed an erasure request ({target}).',
  'admin.audit.msg.erasure_rejected': '{actor} rejected an erasure request ({target}).',
  'admin.audit.msg.principal_erased': '{actor} erased an account ({target}).',
  'admin.audit.msg.retention_anonymize':
  ...
  'admin.audit.msg.vote_delete': '{actor} deleted a vote ({target}).',
  'admin.audit.msg.budget_node_create': '{actor} created a cost centre ({target}).',
  ...
  'admin.audit.msg.budget_transfer_create': '{actor} made a budget transfer ({target}).',
  'admin.audit.msg.budget_invoice_create': '{actor} recorded an invoice ({target}).',
  'admin.audit.msg.budget_invoice_update': '{actor} updated an invoice ({target}).',
  'admin.audit.msg.budget_invoice_delete': '{actor} deleted an invoice ({target}).',
  ...
  'admin.privacy.queueEmpty': 'No erasure requests.',
  'admin.privacy.col.status': 'Status',
  'admin.privacy.col.subject': 'Subject',
  'admin.privacy.col.email': 'Email',
  'admin.privacy.col.created': 'Received',
  'admin.privacy.execute': 'Execute',
  'admin.privacy.reject': 'Reject',
  'admin.privacy.executeTitle': 'Execute erasure',
  'admin.privacy.executeConfirm':
    'Execute this erasure request now? The personal data will be anonymised or deleted — this cannot be undone.',
  'admin.privacy.executed': 'Erasure request executed.',
  'admin.privacy.rejectTitle': 'Reject erasure request',
  'admin.privacy.rejectReason': 'Reason (optional)',
  'admin.privacy.rejected': 'Erasure request rejected.',
  'admin.privacy.status.open': 'Open',
  'admin.privacy.status.executed': 'Executed',
  'admin.privacy.status.rejected': 'Rejected',
  'admin.privacy.subject.applicant': 'Application',
  'admin.privacy.subject.principal': 'Account',
  'admin.privacy.auskunftTitle': 'Data access (Art. 15)',
  'admin.privacy.auskunftHint': 'Export all data stored for an email address as XLSX.',
  'admin.privacy.email': 'Email address',
  'admin.privacy.auskunftExport': 'Export',
  'admin.privacy.auskunftDone': 'Data access report exported.',
  'admin.privacy.principalTitle': 'Erase account (Art. 17)',
  'admin.privacy.principalHint':
    'Clear a principal’s personal data (the sub remains as a pseudonym).',
  'admin.privacy.principalId': 'Principal ID (UUID)',
  'admin.privacy.principalErase': 'Erase account',
  'admin.privacy.principalConfirm':
    'Permanently erase this account’s personal data? This cannot be undone.',
  'admin.privacy.principalErased': 'Account erased.',
  'admin.privacy.retentionTitle': 'Retention (Art. 5(1)(e))',
  'admin.privacy.retentionHint':
    'Global default in months until terminal applications are anonymised.',
  'admin.privacy.retentionMonths': 'Retention (months)',
  ...
  'admin.cdVariants.add': 'Add variant',
  'admin.cdVariants.create': 'Create CD variant',
  'admin.cdVariants.edit': 'Edit CD variant',
  'admin.cdVariants.loading': 'Loading CD variants…',
  'admin.cdVariants.error': 'Could not load the CD variants.',
  'admin.cdVariants.empty': 'No CD variants yet.',
  'admin.cdVariants.name': 'Name',
  'admin.cdVariants.keyHint': 'The name generates it. After the create it cannot change.',
  'admin.cdVariants.keyLocked': 'The key is immutable.',
  ...
  'admin.cdVariants.col.name': 'Name',
  'admin.cdVariants.col.base': 'Base',
  'admin.cdVariants.col.logos': 'Logos',
  'admin.cdVariants.toggleLogos': 'Show logos',
  'admin.cdVariants.slot': 'Position',
  'admin.cdVariants.slot.title': 'Title page',
  'admin.cdVariants.slot.footer': 'Page footer',
  'admin.cdVariants.noLogos': 'No logos yet.',
  ...
  'admin.cdVariants.vendored': 'bundled',
  'admin.cdVariants.uploaded': 'uploaded',
  'admin.cdVariants.vendoredName': 'Logo',
  ...
  'admin.deleg.loading': 'Loading delegations …',
  'admin.deleg.error': 'Failed to load delegations.',
  'admin.deleg.none': 'No delegations yet.',
  'admin.deleg.meeting': 'Meeting',
  'admin.deleg.who': 'Proxy',
  'admin.deleg.flags': 'Properties',
  'admin.deleg.actions': 'Actions',
  'admin.deleg.revoke': 'Revoke',
  'admin.deleg.revokeTitle': 'Revoke delegation',
  'admin.deleg.revokeConfirm': 'Really revoke the delegation to “{name}”?',
  'admin.deleg.cancel': 'Cancel',
  ...
  'admin.substitutes.add': 'Add substitute',
  'admin.substitutes.addAction': 'Add',
  'admin.substitutes.search': 'Search person',
  'admin.substitutes.forMember': 'Substitutes for',
  'admin.substitutes.allMembers': 'All members',
  'admin.substitutes.empty': 'No substitutes designated.',
  'admin.substitutes.col.substitute': 'Substitute',
  'admin.substitutes.col.member': 'Substitutes for',
  'admin.substitutes.remove': 'Remove substitute',
  'admin.substitutes.added': 'Substitute added.',
  'admin.substitutes.removed': 'Substitute removed.',
  ...
  'delegation.card.deadline': 'Can be set up until {date}.',
  'delegation.card.deadlinePassed':
    'The deadline has passed — only pool substitutes are still possible.',
  'delegation.card.setup': 'Arrange proxy',
  'delegation.card.outgoing': 'You are represented by {name}.',
  'delegation.card.incoming': 'You represent {name} in this meeting.',
  ...
  'delegation.dialog.search': 'Search person',
  'delegation.dialog.searchPlaceholder': 'Name or email …',
  'delegation.dialog.poolSuffix': '(substitute)',
  'delegation.dialog.poolHint':
    'Pool substitute — possible without lead time until the meeting starts.',
  'delegation.dialog.externalHint':
    'External person (not a committee member) — allowed because this committee permits external proxies.',
  'delegation.dialog.voting': 'Also transfer voting right',
  'delegation.dialog.votingHint':
    'Your proxy votes on your behalf; you yourself are barred from votes of this meeting.',
  'delegation.dialog.votingDisabled':
  ...
  'delegation.dash.subtitle': 'Your meeting-bound proxies.',
  'delegation.dash.outgoing': 'You are represented by {name}',
  'delegation.dash.incoming': 'You represent {name}',
  ...
  'admin.forms.delete': 'Delete application type',
  'admin.forms.deleteConfirm':
  ...
  'admin.forms.cmpRequired': 'Comparison offers required',
  'admin.forms.cmpRequiredHint': 'Applicants must attach comparison offers.',
  'admin.forms.cmpMinCount': 'Minimum count',
  'admin.forms.col.budget': 'Budget',
  ...
  'admin.gremien.cdVariantNone': '— (pytex default)',
  'admin.gremien.cdVariantHint':
    'Sets the logos of the rendered documents. Maintain the variants under “CD variants”.',
  ...
  'admin.gremien.delegationShort': 'Delegation',
  'admin.gremien.delegationHint':
    'Members may arrange a proxy for individual meetings of this committee.',
  'admin.gremien.delegationLead': 'Lead time for delegations (minutes)',
  'admin.gremien.delegationLeadHint':
    'A proxy can be set up until this many minutes before the meeting starts (0 = until start). Pool substitutes are exempt from the lead time.',
  'admin.gremien.delegationExternal': 'Allow delegation to externals',
  'admin.gremien.delegationExternalHint':
    'Users outside the committee and substitute pool may also be chosen as proxy.',
  'admin.gremien.quorum': 'Quorum (%)',
  'admin.gremien.quorumHint':
  ...
  'admin.gremien.memberEdit': 'Edit membership',
  'admin.gremien.memberEditFor': 'Member',
  'admin.gremien.memberSaved': 'Membership saved.',
  'admin.gremien.memberTermHint':
    'The person and the committee stay unchanged. An empty field keeps that end of the term open.',
  'admin.gremien.memberBadTerm': 'The from date must be before the until date.',
  ...
  'admin.users.editAssignment': 'Edit assignment',
  'admin.users.editHint':
    'An empty date field stays as it is. A set validity cannot be removed here: revoke the role and assign it again.',
  'admin.users.editSaved': 'Assignment updated.',
  'admin.users.editFailed': 'Could not change the assignment.',
  'admin.users.editSelfBlocked': 'You cannot change your own admin assignment.',
  ...
  'admin.mailTemplates.subtitle':
    'Edit subject, text and HTML of notification emails per language (Jinja2 placeholders).',
  'admin.mailTemplates.empty': 'No templates yet.',
  'admin.mailTemplates.selectHint': 'Pick a template on the left to edit.',
  'admin.mailTemplates.key.magic_link': 'Sign-in link',
  'admin.mailTemplates.key.status_update': 'Status change',
  'admin.mailTemplates.key.status_update_team': 'Status change (team)',
  'admin.mailTemplates.key.deadline_approaching': 'Deadline reminder',
  'admin.mailTemplates.key.task_new': 'New task',
  'admin.mailTemplates.key.task_reminder': 'Task reminder',
  'admin.mailTemplates.key.comment_applicant': 'Comment (applicant)',
  'admin.mailTemplates.key.comment_team': 'Comment (team)',
  'admin.mailTemplates.key.meeting_created': 'New meeting',
  'admin.mailTemplates.key.role_assigned': 'Role assigned',
  'admin.mailTemplates.key.role_revoked': 'Role revoked',
  'admin.mailTemplates.key.delegation_granted': 'Proxy received',
  'admin.mailTemplates.key.delegation_revoked': 'Proxy revoked',
  'admin.mailTemplates.customized': 'customized',
  'admin.mailTemplates.reset': 'Reset to default',
  'admin.mailTemplates.resetDone': 'Reset to default.',
  'admin.mailTemplates.subject': 'Subject',
  'admin.mailTemplates.body': 'Text',
  'admin.mailTemplates.bodyHtml': 'HTML (optional)',
  'admin.mailTemplates.bodyHtmlPlaceholder': 'Leave empty for a plain-text email',
  'admin.mailTemplates.placeholders': 'Placeholders',
  'admin.mailTemplates.preview': 'Preview',
  'admin.mailTemplates.previewHeading': 'Preview',
  'admin.mailTemplates.saved': 'Template saved.',
  'admin.mailTemplates.failed': 'Save failed.',
