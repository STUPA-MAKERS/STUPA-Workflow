...
export const de = {
  ...
  'budget.tree.subtitle': 'Hierarchische Budgets: Top-Budget → Kostenstellen. Verfügbar = Roll-Down, gebunden = Roll-Up.',
  ...
  'budget.tree.createTop': 'Top-Budget anlegen',
  ...
  'budget.tree.fyTop': 'Top-Budget',
  'budget.tree.fyTopPlaceholder': 'Top-Budget wählen …',
...
export const en: Partial<Record<TranslationKey, string>> = {
  ...
  'budget.tree.subtitle': 'Hierarchical budgets: top budget → cost centres. Available = roll-down, committed = roll-up.',
  'budget.tree.budget': 'Budget',
  ...
  'budget.tree.createTop': 'Create top budget',
  'budget.tree.key': 'Key',
  ...
  'budget.tree.fyTop': 'Top budget',
  'budget.tree.fyTopPlaceholder': 'Choose a top budget …',
