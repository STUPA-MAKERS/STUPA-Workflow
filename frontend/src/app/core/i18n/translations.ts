...
export const de = {
  ...
  'konten.noLinkCandidates': 'Keine passende, noch nicht verknüpfte Buchung (gleiches Konto, Art, Betrag).',
...
export const en: Partial<Record<TranslationKey, string>> = {
  ...
  'konten.noLinkCandidates': 'No matching unlinked booking (same account, kind, amount).',
